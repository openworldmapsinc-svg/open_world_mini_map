...
CITIES: [
  {n:'Gulf Shores',        s:'AL', lat:30.2460, lng:-87.7008, z:'s'},
  {n:'Birmingham',         s:'AL', lat:33.5186, lng:-86.8104, z:'m'},
  {n:'Huntsville',         s:'AL', lat:34.7304, lng:-86.5861, z:'m'},

  {n:'Anchorage',          s:'AK', lat:61.2181, lng:-149.9003, z:'m'},
  {n:'Juneau',             s:'AK', lat:58.3019, lng:-134.4197, z:'s'},
  {n:'Ketchikan',          s:'AK', lat:55.3422, lng:-131.6461, z:'s'},

  {n:'Phoenix',            s:'AZ', lat:33.4484, lng:-112.0740, z:'l'},
  {n:'Tucson',             s:'AZ', lat:32.2226, lng:-110.9747, z:'l'},
  {n:'Flagstaff',          s:'AZ', lat:35.1983, lng:-111.6513, z:'s'},

  {n:'Hot Springs',        s:'AR', lat:34.5037, lng:-93.0552, z:'s'},
  {n:'Bentonville',        s:'AR', lat:36.3729, lng:-94.2088, z:'s'},
  {n:'Eureka Springs',     s:'AR', lat:36.4015, lng:-93.7377, z:'s'},

  {n:'Los Angeles',        s:'CA', lat:34.0522, lng:-118.2437, z:'l'},
  {n:'San Francisco',      s:'CA', lat:37.7749, lng:-122.4194, z:'l'},
  {n:'San Diego',          s:'CA', lat:32.7157, lng:-117.1611, z:'l'},

  {n:'Denver',             s:'CO', lat:39.7392, lng:-104.9903, z:'l'},
  {n:'Colorado Springs',   s:'CO', lat:38.8339, lng:-104.8214, z:'m'},
  {n:'Aspen',              s:'CO', lat:39.1911, lng:-106.8175, z:'s'},

  {n:'Mystic',             s:'CT', lat:41.3543, lng:-71.9665, z:'s'},
  {n:'New Haven',          s:'CT', lat:41.3083, lng:-72.9279, z:'m'},
  {n:'Hartford',           s:'CT', lat:41.7658, lng:-72.6734, z:'m'},

  {n:'Rehoboth Beach',     s:'DE', lat:38.7209, lng:-75.0760, z:'s'},
  {n:'Wilmington',         s:'DE', lat:39.7459, lng:-75.5466, z:'s'},

  {n:'Orlando',            s:'FL', lat:28.5383, lng:-81.3792, z:'m'},
  {n:'Miami',              s:'FL', lat:25.7617, lng:-80.1918, z:'m'},
  {n:'Key West',           s:'FL', lat:24.5551, lng:-81.7800, z:'s'},

  {n:'Atlanta',            s:'GA', lat:33.7490, lng:-84.3880, z:'l'},
  {n:'Savannah',           s:'GA', lat:32.0809, lng:-81.0912, z:'m'},

  {n:'Honolulu',           s:'HI', lat:21.3069, lng:-157.8583, z:'m'},
  {n:'Lahaina',            s:'HI', lat:20.8783, lng:-156.6825, z:'s'},
  {n:'Kailua-Kona',        s:'HI', lat:19.6400, lng:-155.9969, z:'s'},

  {n:'Boise',              s:'ID', lat:43.6150, lng:-116.2023, z:'m'},
  {n:"Coeur d'Alene",      s:'ID', lat:47.6777, lng:-116.7805, z:'s'},
  {n:'Sun Valley',         s:'ID', lat:43.6968, lng:-114.3517, z:'s'},

  {n:'Chicago',            s:'IL', lat:41.8781, lng:-87.6298, z:'l'},

  {n:'Indianapolis',       s:'IN', lat:39.7684, lng:-86.1581, z:'l'},
  {n:'Bloomington',        s:'IN', lat:39.1653, lng:-86.5264, z:'s'},

  {n:'Des Moines',         s:'IA', lat:41.5868, lng:-93.6250, z:'m'},
  {n:'Dubuque',            s:'IA', lat:42.5006, lng:-90.6646, z:'s'},

  {n:'Wichita',            s:'KS', lat:37.6872, lng:-97.3301, z:'m'},
  {n:'Lawrence',           s:'KS', lat:38.9717, lng:-95.2353, z:'s'},

  {n:'Louisville',         s:'KY', lat:38.2527, lng:-85.7585, z:'l'},
  {n:'Lexington',          s:'KY', lat:38.0406, lng:-84.5037, z:'m'},
  {n:'Bardstown',          s:'KY', lat:37.8092, lng:-85.4669, z:'s'},

  {n:'New Orleans',        s:'LA', lat:29.9511, lng:-90.0715, z:'m'},
  {n:'Baton Rouge',        s:'LA', lat:30.4515, lng:-91.1871, z:'m'},

  {n:'Bar Harbor',         s:'ME', lat:44.3876, lng:-68.2039, z:'s'},
  {n:'Portland',           s:'ME', lat:43.6591, lng:-70.2568, z:'s'},
  {n:'Ogunquit',           s:'ME', lat:43.2492, lng:-70.5990, z:'s'},

  {n:'Ocean City',         s:'MD', lat:38.3365, lng:-75.0849, z:'s'},
  {n:'Baltimore',          s:'MD', lat:39.2904, lng:-76.6122, z:'l'},
  {n:'Annapolis',          s:'MD', lat:38.9784, lng:-76.4922, z:'s'},

  {n:'Boston',             s:'MA', lat:42.3601, lng:-71.0589, z:'l'},
  {n:'Salem',              s:'MA', lat:42.5195, lng:-70.8967, z:'s'},
  {n:'Provincetown',       s:'MA', lat:42.0584, lng:-70.1787, z:'s'},

  {n:'Detroit',            s:'MI', lat:42.3314, lng:-83.0458, z:'l'},
  {n:'Mackinac Island',    s:'MI', lat:45.8492, lng:-84.6189, z:'s'},
  {n:'Traverse City',      s:'MI', lat:44.7631, lng:-85.6206, z:'s'},

  {n:'Minneapolis',        s:'MN', lat:44.9778, lng:-93.2650, z:'m'},
  {n:'Duluth',             s:'MN', lat:46.7867, lng:-92.1005, z:'s'},

  {n:'Biloxi',             s:'MS', lat:30.3960, lng:-88.8853, z:'s'},
  {n:'Natchez',            s:'MS', lat:31.5604, lng:-91.4032, z:'s'},

  {n:'St. Louis',          s:'MO', lat:38.6270, lng:-90.1994, z:'m'},
  {n:'Branson',            s:'MO', lat:36.6437, lng:-93.2185, z:'s'},
  {n:'Kansas City',        s:'MO', lat:39.0997, lng:-94.5786, z:'l'},

  {n:'Bozeman',            s:'MT', lat:45.6770, lng:-111.0429, z:'s'},
  {n:'Whitefish',          s:'MT', lat:48.4111, lng:-114.3376, z:'s'},

  {n:'Omaha',              s:'NE', lat:41.2565, lng:-95.9345, z:'m'},
  {n:'Lincoln',            s:'NE', lat:40.8136, lng:-96.7026, z:'m'},

  {n:'Las Vegas',          s:'NV', lat:36.1699, lng:-115.1398, z:'l'},
  {n:'Reno',               s:'NV', lat:39.5296, lng:-119.8138, z:'m'},

  {n:'North Conway',       s:'NH', lat:44.0537, lng:-71.1284, z:'s'},
  {n:'Portsmouth',         s:'NH', lat:43.0718, lng:-70.7626, z:'s'},

  {n:'Atlantic City',      s:'NJ', lat:39.3643, lng:-74.4229, z:'s'},
  {n:'Cape May',           s:'NJ', lat:38.9351, lng:-74.9060, z:'s'},
  {n:'Asbury Park',        s:'NJ', lat:40.2204, lng:-74.0121, z:'s'},

  {n:'Albuquerque',        s:'NM', lat:35.0844, lng:-106.6504, z:'l'},
  {n:'Santa Fe',           s:'NM', lat:35.6870, lng:-105.9378, z:'s'},
  {n:'Taos',               s:'NM', lat:36.4072, lng:-105.5731, z:'s'},

  {n:'New York City',      s:'NY', lat:40.7128, lng:-74.0060, z:'l'},
  {n:'Niagara Falls',      s:'NY', lat:43.0962, lng:-79.0377, z:'s'},

  {n:'Charlotte',          s:'NC', lat:35.2271, lng:-80.8431, z:'l'},
  {n:'Tryon',              s:'NC', lat:35.2098, lng:-82.2382, z:'s'},
  {n:'Asheville',          s:'NC', lat:35.5951, lng:-82.5515, z:'s'},

  {n:'Fargo',              s:'ND', lat:46.8772, lng:-96.7898, z:'m'},
  {n:'Medora',             s:'ND', lat:46.9139, lng:-103.5238, z:'s'},

  {n:'Cleveland',          s:'OH', lat:41.4993, lng:-81.6944, z:'m'},
  {n:'Cincinnati',         s:'OH', lat:39.1031, lng:-84.5120, z:'m'},
  {n:'Columbus',           s:'OH', lat:39.9612, lng:-82.9988, z:'l'},

  {n:'Oklahoma City',      s:'OK', lat:35.4676, lng:-97.5164, z:'l'},
  {n:'Tulsa',              s:'OK', lat:36.1540, lng:-95.9928, z:'m'},

  {n:'Portland',           s:'OR', lat:45.5152, lng:-122.6784, z:'l'},
  {n:'Bend',               s:'OR', lat:44.0582, lng:-121.3153, z:'m'},
  {n:'Cannon Beach',       s:'OR', lat:45.8918, lng:-123.9615, z:'s'},

  {n:'Philadelphia',       s:'PA', lat:39.9526, lng:-75.1652, z:'l'},
  {n:'Pittsburgh',         s:'PA', lat:40.4406, lng:-79.9959, z:'m'},
  {n:'Gettysburg',         s:'PA', lat:39.8309, lng:-77.2311, z:'s'},

  {n:'Newport',            s:'RI', lat:41.4901, lng:-71.3128, z:'s'},
  {n:'Providence',         s:'RI', lat:41.8240, lng:-71.4128, z:'m'},

  {n:'Myrtle Beach',       s:'SC', lat:33.6891, lng:-78.8867, z:'s'},
  {n:'Charleston',         s:'SC', lat:32.7765, lng:-79.9311, z:'m'},
  {n:'Hilton Head Island', s:'SC', lat:32.2163, lng:-80.7526, z:'s'},

  {n:'Rapid City',         s:'SD', lat:44.0805, lng:-103.2310, z:'s'},
  {n:'Deadwood',           s:'SD', lat:44.3767, lng:-103.7296, z:'s'},

  {n:'Nashville',          s:'TN', lat:36.1627, lng:-86.7816, z:'l'},
  {n:'Memphis',            s:'TN', lat:35.1495, lng:-90.0490, z:'l'},
  {n:'Gatlinburg',         s:'TN', lat:35.7143, lng:-83.5102, z:'s'},

  {n:'San Antonio',        s:'TX', lat:29.4241, lng:-98.4936, z:'l'},
  {n:'Houston',            s:'TX', lat:29.7604, lng:-95.3698, z:'l'},
  {n:'Austin',             s:'TX', lat:30.2672, lng:-97.7431, z:'l'},

  {n:'Salt Lake City',     s:'UT', lat:40.7608, lng:-111.8910, z:'m'},
  {n:'Park City',          s:'UT', lat:40.6461, lng:-111.4980, z:'s'},
  {n:'Moab',               s:'UT', lat:38.5733, lng:-109.5498, z:'s'},

  {n:'Burlington',         s:'VT', lat:44.4759, lng:-73.2121, z:'s'},
  {n:'Stowe',              s:'VT', lat:44.4654, lng:-72.6874, z:'s'},

  {n:'Virginia Beach',     s:'VA', lat:36.8529, lng:-75.9780, z:'m'},
  {n:'Williamsburg',       s:'VA', lat:37.2707, lng:-76.7075, z:'s'},
  {n:'Alexandria',         s:'VA', lat:38.8048, lng:-77.0469, z:'m'},

  {n:'Seattle',            s:'WA', lat:47.6062, lng:-122.3321, z:'l'},
  {n:'Spokane',            s:'WA', lat:47.6588, lng:-117.4260, z:'m'},
  {n:'Leavenworth',        s:'WA', lat:47.5962, lng:-120.6615, z:'s'},

  {n:'Harpers Ferry',      s:'WV', lat:39.3256, lng:-77.7383, z:'s'},
  {n:'Lewisburg',          s:'WV', lat:37.8018, lng:-80.4459, z:'s'},

  {n:'Wisconsin Dells',    s:'WI', lat:43.6275, lng:-89.7710, z:'s'},
  {n:'Milwaukee',          s:'WI', lat:43.0389, lng:-87.9065, z:'l'},
  {n:'Madison',            s:'WI', lat:43.0731, lng:-89.4012, z:'m'},

  {n:'Jackson',            s:'WY', lat:43.4799, lng:-110.7624, z:'s'},
  {n:'Cody',               s:'WY', lat:44.5263, lng:-109.0565, z:'s'}
]
};
